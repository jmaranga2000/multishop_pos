...
import { detectMixedUnitSaleConflict, getSyncQueueStatuses, type SyncPendingSalesOptions } from "@/lib/offline/conflicts";
import type { OfflineInventory, OfflineProduct, OfflineSale, OfflineSaleItem, SyncQueueItem } from "@/lib/offline/types";

export { detectMixedUnitSaleConflict, getSyncQueueStatuses };
export type { SyncPendingSalesOptions } from "@/lib/offline/conflicts";
