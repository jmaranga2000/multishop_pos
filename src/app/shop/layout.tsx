...
export default async function ShopLayout({children}:{children:React.ReactNode}){
 ...
 const nav=[{href:"/shop/dashboard",label:"Dashboard",icon:Gauge},{href:"/shop/pos",label:"Point of sale",icon:ShoppingCart},{href:"/shop/sales",label:"Sales",icon:ReceiptText},{href:"/shop/stock",label:"Stock",icon:Boxes},{href:"/shop/register",label:"Register",icon:Wallet},{href:"/shop/transfers",label:"Transfers",icon:ArrowLeftRight},{href:"/shop/expenses",label:"Expenses",icon:Store},{href:"/shop/refund-request",label:"Refund request",icon:RotateCcw},{href:"/shop/synchronization",label:"Synchronization",icon:RefreshCw},{href:"/shop/profile",label:"Profile",icon:Settings}];
