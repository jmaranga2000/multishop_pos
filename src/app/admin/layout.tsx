import { BarChart3, Bell, Boxes, Building2, FileSpreadsheet, MonitorSmartphone, RefreshCw, Settings, ShoppingCart, Store, UsersRound, Wallet, ArrowLeftRight } from "lucide-react";
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const nav = [
    ...
    { href: "/admin/reports/inventory", label: "Reports", icon: FileSpreadsheet },
